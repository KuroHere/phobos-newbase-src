...
class FlatInputMaps
{
    ...
    private static void initTextComponentInputMaps(final UIDefaults defaults) {
        ...
        final Object[] macMultiLineTextComponentBindings = (Object[])(SystemInfo.isMacOS ? new Object[] { "ctrl N", "caret-down", "ctrl P", "caret-up", "shift alt UP", "selection-begin-paragraph", "shift alt DOWN", "selection-end-paragraph", "shift alt KP_UP", "selection-begin-paragraph", "shift alt KP_DOWN", "selection-end-paragraph", "ctrl V", "page-down" } : null);
    ...
    private static void modifyInputMap(final BooleanSupplier condition, final UIDefaults defaults, final String key, final Object... bindings) {
        defaults.put(key, new LazyModifyInputMap(condition, ((Hashtable<K, Object>)defaults).remove(key), bindings));
    }
    ...
    private static class LazyModifyInputMap implements UIDefaults.LazyValue
    {
        ...
        LazyModifyInputMap(final BooleanSupplier condition, final Object baseInputMap, final Object[] bindings) {
