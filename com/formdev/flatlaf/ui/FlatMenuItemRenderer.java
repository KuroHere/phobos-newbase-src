...
public class FlatMenuItemRenderer
{
    ...
    protected FlatMenuItemRenderer(final JMenuItem menuItem, final Icon checkIcon, final Icon arrowIcon, final Font acceleratorFont, final String acceleratorDelimiter) {
        ...
        this.selectionBackground = UIManager.getColor("MenuItem.selectionBackground");
    ...
    protected void paintUnderlineSelection(final Graphics g, final Color underlineSelectionColor, final int underlineSelectionHeight) {
    ...
    protected void paintIcon(final Graphics g, final Rectangle iconRect, final Icon icon, final Color checkBackground) {
