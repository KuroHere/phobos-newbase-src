...
public class Weather extends Module
{
    ...
    public Weather() {
        ...
        this.snow = this.register(new BooleanSetting("Snow", true));
        this.height = this.register(new NumberSetting("Height", 80, 0, 255));
        this.strength = this.register(new NumberSetting("Strength", 0.8f, 0.1f, 2.0f));
    }
        ...
        for (int k2 = k - i2; k2 <= k + i2; ++k2) {
            for (int l2 = i - i2; l2 <= i + i2; ++l2) {
                ...
                if (k3 != l3) {
                    ...
                    final float f3 = biome.getFloatTemperature((BlockPos)blockpos$mutableblockpos);
